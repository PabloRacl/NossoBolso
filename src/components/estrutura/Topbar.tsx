...
import { Plus, Calendar, Tag, ChevronLeft, ChevronRight, Sparkles, Eye, EyeOff, Bell, Search, Menu, History, Database, Mic, Compass, Palette, FileText, Keyboard, Smartphone, Activity, User as UserIcon, LogIn } from 'lucide-react';
...
export const Topbar: React.FC = () => {
  ...
  const pageTitles: Record<string, { title: string; subtitle: string }> = {
    dashboard: { title: 'Painel Geral', subtitle: 'Visão geral das suas finanças, patrimônio e despesas' },
